        ...
        <div className="contact-form col-md-7 col-sm-10 col-xs-12 row center-xs">
          ...
          <address>
            <h2 className="col-xs-12 phone-number">
              <span><PhoneIcon /></span>
              <span className="number-text">+91 948742654</span>
            </h2>
            <a className="col-xs-12 email-address" href="mailto:drona.buildingnation@gmail.com">
              <span><MailIcon color="#8d8d8d" /></span>
              <span className="email-text">drona.buildingnation@gmail.com</span>
            </a>
          </address>
